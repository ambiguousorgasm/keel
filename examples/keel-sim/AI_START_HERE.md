...
- **Task prefix:** SIM  (task IDs look like `SIM-001-slug`)
- **Purpose:** Validate KEEL's gates with synthetic agents; mechanism not realism.
- **Current phase:** see `STATUS.md`
- **Subsystems:** substrate, profiles, gate, runner, metrics, experiments
